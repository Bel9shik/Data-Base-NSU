...
(
    ...
    headStation   varchar(100) not null,
...
(
    id           int generated by default as identity primary key,
    passportDara varchar(50) not null unique,
...
(
    ...
    categoryComfort      varchar(30) not null,
...
(
    ...
    brigadeID  int,
    stationID  int references stations (id),
    check (stationID is not null or brigadeID is null)
);
